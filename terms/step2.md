...
**제3조(개인정보 파기절차 및 방법)**<br>
  &nbsp;① 회사는 이용자의 개인정보 수집 및 이용목적이 달성되거나, 뵤유 및 이용기간이 경과된 후에는 해당 정보를 지체 없이 파기합니다.
...
**제7조(쿠키(cookie)의 운영에 관한 사항)**<br>
  ...
  &bnsp;&nbsp;(나) 쿠키의 설치•운영 및 거부 : 웹브라우저 상단의 도구>인터넷 옵션>개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부 할 수 있습니다.<br>
